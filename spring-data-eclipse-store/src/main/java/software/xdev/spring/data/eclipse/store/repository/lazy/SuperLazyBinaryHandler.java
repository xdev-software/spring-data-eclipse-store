 ...
 */
public class SuperLazyBinaryHandler extends AbstractBinaryHandlerCustom<Lazy.Default<?>>
{
	///////////////////////////////////////////////////////////////////////////
	// static methods //
	///////////////////
	
	public static SuperLazyBinaryHandler New()
	{
		return new SuperLazyBinaryHandler();
	}
	...
	private SuperLazyBinaryHandler()
	{
		super(
	...
	public final Lazy.Default<?> create(final Binary data, final PersistenceLoadHandler handler)
	{
		...
		final Lazy.Default<?> newLazy = Lazy.register(
			XReflect.invoke(CONSTRUCTOR, null, objectId, null)
		);
		return LazyProxyGenerator.generateLazyProxy(newLazy);
	}
