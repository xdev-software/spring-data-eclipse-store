...
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdInt;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdIntRepository;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdInteger;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdIntegerNoAutoGenerate;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdIntegerNoAutoGenerateRepository;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdIntegerRepository;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdLong;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdLongRepository;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdString;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithIdStringRepository;
import software.xdev.spring.data.eclipse.store.integration.repositories.id.CustomerWithPurchase;
