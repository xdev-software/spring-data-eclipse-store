...
public class ObjectWithLazyHashSet
{
	...
	public LazyHashSet<SimpleObject> getLazyHashSet()
	{
		return this.lazyHashSet;
	}
	
	public void setLazyHashSet(final LazyHashSet<SimpleObject> lazyHashSet)
	{
		this.lazyHashSet = lazyHashSet;
	}
}
